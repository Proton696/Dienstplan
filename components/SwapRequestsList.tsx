...
export function SwapRequestsList({
  ...
  return (
    <div className="px-4 pb-8 space-y-6 max-w-full overflow-x-hidden">
      {/* Pending */}
      <div>
          ...
          <div className="space-y-2">
            {resolvedRequests.slice(0, 10).map((req) => {
              ...
              return (
                <div
                  key={req.id}
                  className="glass rounded-2xl px-4 py-3 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 min-w-0"
                >
...
function SwapRequestCard({
  ...
  return (
    <div className="glass rounded-3xl p-4 shadow-apple-sm space-y-3 min-w-0 max-w-full overflow-hidden">
      {/* Header */}
      ...
      <div className="bg-white/[0.04] rounded-2xl p-3 space-y-2.5">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-white/40 text-xs truncate">{formatDate(request.from_date)}</p>
          </div>
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-white/40 text-xs truncate">{formatDate(request.to_date)}</p>
          </div>
